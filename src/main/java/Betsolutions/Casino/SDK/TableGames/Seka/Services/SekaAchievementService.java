...
import Betsolutions.Casino.SDK.TableGames.Seka.DTO.GetSekaAchievementsResponseContainer;
import Betsolutions.Casino.SDK.TableGames.Seka.DTO.SekaAchievementsFilter;
...
public class SekaAchievementService extends BaseService {
    public SekaAchievementService(MerchantAuthInfo merchantAuthInfo) {
        super(merchantAuthInfo, "SekaAchievement");
    }

    public GetSekaAchievementsResponseContainer GetAchievements(SekaAchievementsFilter requestModel) {
        ...
        String requestJsonStr = gson.toJson(requestModel, SekaAchievementsFilter.class);
        ...
        try {
            ...
            return new GetSekaAchievementsResponseContainer(StatusCode.GeneralError, e.getMessage());
        }
        ...
        return gson.fromJson(responseBodyStr, GetSekaAchievementsResponseContainer.class);
    }
}
